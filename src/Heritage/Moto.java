...
public class Moto extends Vehicule implements Pompe {
	...
	public void verif() {
		if(typeCarb==typeCarburant) {
			System.out.println("vous pouvez passer à la station, a meme type de carburant que votre vehicule,");
		}else {
			System.out.println("vous ne pouvez passer à la station, n'a pas meme type de carburant que votre vehicule,");
		}
	}
